        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <div className="flex gap-3">
              ...
              <a href={settings.facebook} target="_blank" rel="noopener noreferrer" className="bg-white/5 text-white p-3 rounded-xl hover:bg-blue-600 hover:text-white transition-all" aria-label="Facebook"><Facebook size={20} /></a>
              <a href={settings.instagram} target="_blank" rel="noopener noreferrer" className="bg-white/5 text-white p-3 rounded-xl hover:bg-pink-600 hover:text-white transition-all" aria-label="Instagram"><Instagram size={20} /></a>
            </div>
          </div>
            ...
            {settings.poweredByLogo && (
              <div className="flex items-center gap-3">
                 ...
                 <img 
                   ...
                   alt="Powered By" 
                   className="h-6 w-auto opacity-50 hover:opacity-100 transition-opacity brightness-0 invert" 
                 />
              </div>
            )}
          </div>
