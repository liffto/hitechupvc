...
const HomePage: React.FC<HomePageProps> = ({ categories, catalogs, settings, testimonials }) => {
  ...
  return (
    <Layout settings={settings}>
        ...
        {settings.heroBanners.length > 0 ? (
          settings.heroBanners.map((banner, idx) => (
            <img 
              ...
              // Optimization: high priority only for the first banner to improve LCP
      ...
      {/* Our Products Section - Updated grid to grid-cols-1 on small screens */}
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {categories.slice(0, 8).map((cat, index) => (
              ...
              >
                <div className="h-64 sm:h-72 md:h-52 overflow-hidden rounded-xl flex items-center justify-center bg-gray-50">
                  <img 
                    src={cat.image} 
                    alt={cat.name} 
                    loading="lazy"
                ...
                <div className="py-6 px-1">
                  <h3 className="font-extrabold text-black text-lg md:text-lg text-center">{cat.name}</h3>
                </div>
              </Link>
            ))}
          </div>
      ...
      <section className="py-12 md:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
            <div className="rounded-3xl overflow-hidden shadow-2xl h-[350px] md:h-[450px] bg-gray-200">
              <img 
