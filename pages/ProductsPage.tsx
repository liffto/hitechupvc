  ...
  return (
    <Layout settings={settings}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        {/* Updated grid: grid-cols-1 by default, md:grid-cols-2 on medium screens */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {categories.map((cat) => (
            ...
            >
              <div className="h-72 sm:h-80 md:h-60 overflow-hidden rounded-lg flex items-center justify-center bg-gray-50">
                <img 
                  src={cat.image} 
                  alt={cat.name} 
                  loading="lazy"
              ...
              <div className="py-5 px-2">
                <h3 className="text-lg md:text-lg font-extrabold text-black tracking-tight">{cat.name}</h3>
                {cat.description && (
